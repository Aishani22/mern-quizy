  ...
  <div className="card flex flex-col md:flex-row text-black gap-6 md:gap-4 h-full">
    ...
    <div className="w-full md:w-2/3 flex flex-col justify-between text-left relative mx-2">
      <div className="card-body">
        <h5 className="card-title text-xl font-semibold mb-2 leading-snug pr-3" style={{ textAlign: "justify" }}>
          {article.title}
        </h5>
        <p className="mt-2 text-gray-700 text-base leading-relaxed pr-3" style={{ textAlign: "justify" }}>
